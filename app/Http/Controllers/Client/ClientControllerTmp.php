...
class ClientControllerTmp extends Controller
{
    ...
    public function index()
    {
        ...
        return view('client2.pages.home', compact('category', 'blogs'));
    }
    public function products(Request $request)
    {
        ...
        if (request('slug_cate')) {
            $category = Category::where('slug', request('slug_cate'))->first();
            $categories_slug = $category ? $category : "";
        }
        ...
        $categories = $this->categories->load('products');
        return view('client2.pages.products', compact('category','categories', 'products', 'categories_slug'));
    }
    public function productDetail(Request $request, $slug)
    {
        ...
        $RelatedProducts = Product::where('slug', '!=', $slug)
            ...
            ->orderBy('id', 'DESC')
            ->get();
        return view('client2.pages.product', compact('Product', 'RelatedProducts'));
    }
    public function blogs(Request $request)
    {
        ...
        return view('client2.pages.blogs', compact('blogs', 'CategoryBlogs', 'categories_slug'));
    }
    public function blog(Request $request, $slug)
    {
        ...
        $Blog->load('User');
        //dd($Blog);
        return view('client2.pages.blog', compact('Blog', 'CategoryBlogs', 'categories_slug', 'RelatedCategorys'));
    }
    ...
    public function carts()
    {
        ...
        return view('client2.pages.carts', compact('carts', 'totalMoney'));
    }
    ...
    public function order()
    {
        ...
        return view('client2.pages.order', compact('Orders'));
    }
    public function order_detail(Request $request, $id)
    {
        ...
        if ($Orders) {
            ...
            return view('client2.pages.order_detail', compact('Orders', 'totalMoney'));
        }
        return redirect()->back()->with('error', 'Không tìm thấy sản phẩn của đơn hàng');
    }
    public function contact()
    {
        return view('client2.pages.contact');
    }
    ...
    {
        return view('client2.pages.profile');
    }
    public function UpdateProfile(Request $request)
    {
        try {
            ...
            $data = $request->only(['fullname', 'phone', 'address', 'email']);
