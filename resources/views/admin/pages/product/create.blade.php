    ...
    <div class="card-body">
        <div class="table-responsive">
            <form class="user" action="{{ route('cp-admin.products.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group row">
                    <div class="col-sm-12 mb-3 mb-sm-0"><label for="slugCategories">Anh sản phẩm chính<span class="text-danger">(*)</span></label>
                ...
                <div class="form-group row">
                    <div class="col-sm-12 mb-3 mb-sm-0">
                        <label for="slugCategories">Ảnh sản phẩm (có thể chọn nhiều)<span class="text-danger">(*)</span></label>
                        <div class="custom-file">
