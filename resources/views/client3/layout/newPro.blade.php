                                    ...
                                    <div class="navbar-collapse-1">
                                          <ul class="nav navbar-nav">
                                                <li class="nav-item active">
                                                      <a class="nav-link" data-toggle="pill" href="#tab-1">Sản phẩm nổi
                                                            bật</a>
                                                </li>
                                                <li class="nav-item">
                                                      <a class="nav-link" data-toggle="pill" href="#tab-2">Sản phẩm
                                                            mới</a>
                                                </li>
                                                <li class="nav-item">
                                                      <a class="nav-link" data-toggle="pill" href="#tab-3">Sản phẩm
                                                            khuyến mãi</a>
                                                </li>
                                                ...
                                                <div class="item col-md-3">
                                                      <div class="card border-primary">
                                                            <a href=""><img class="card-img-top"
                                                                        src="https://themesground.com/agrifarm-demo/V1/products-images/product8.jpg"
                                                                        alt=""></a>
                                                            <div class="card-body">
                                                                  <a href="">
                                                                        ...
                                                                        <div class="item-price">
                                                                              <div class="price-box"> <span
                                                                                          class="regular-price"> <span
                                                                                                class="price">45.000đ</span>
                                                                                    </span> </div>
                                                                        </div>
                                                                        <div class="action">
                                                                              <button class="button btn-cart"
                                                                                    type="button" title=""
                                                                                    data-original-title="Thêm giỏ hàng"><i
                                                      ...
                                                      <div class="item-content">
                                                            <div class="item-price">
                                                                  <div class="price-box"> <span class="regular-price">
                                                                              <span class="price">45.000đ</span> </span>
                                                                  </div>
                                                            </div>
                                                            <div class="action">
      ...
      <div class="container">
            <div class="row">
                  <div class="col-md-12">
                        ...
                        <div class="col-md-4">
                              <div class="article-title-new">Bài viết mới nhất</div>
                        </div>
                        <div class="col-md-4">
                              <div class="speration"></div>
                        </div>
                        ...
                        <div class="block-new-1">
                              <div class="col-md-4">
                                    <div class="card-group">
                                          <div class="card">
                                                <a href=""><img class="card-img-top"
                                                            src="https://demo2wpopal.b-cdn.net/freshio/wp-content/uploads/2020/08/image-13-copyright-min-410x250.jpg"
                                                            alt="Card image cap"></a>
                                                <div class="card-body" style="width:240px;">
                                                      <a href="">
                                                            <h4 class="card-title">5 lý do bạn phải ăn rau xanh mỗi ngày
                                                            </h4>
                                                      </a>
                                                      <a href="" class="web"><small style="margin-right: 10px">SỨC
                                                                  KHỎE</small> <small>18/04/2000</small></a>
                                                      <a href="">
                                                            <p class="card-text" style="color: #656565;">Chúng ta có thể
                                                                  ăn bánh mì, trứng, chuối, uống sữa, trà mỗi ngày,
                                                                  nhưng đừng quên cân đối số lượng, không sử dụng quá
                                                                  nhiều.</p>
                                                      </a>
                                                </div>
                                          </div>
