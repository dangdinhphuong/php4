                        ...
                        @if(isset($cate->products->last()->image) && !empty($cate->products->last()->image))
                            <div class="col-lg-3">
                                <div class="categories__item set-bg"
                                     data-setbg="{{asset('storage/' .$cate->products->last()->image)}}">
                                    <h5>
                                ...
                                <div class="col-lg-3 col-md-4 col-sm-6 mix {{$category[$i]->slug}} fresh-meat">
                                    <div class="product__discount__item featured__item">
                                        <div class="product__discount__item__pic set-bg"
                                             data-setbg="{{asset('storage/' .$category[$i]->products[$y]->image)}}">
                                            @if($category[$i]->products[$y]->discounts > 0)
                                                <div class="product__discount__percent">
                                                    -{{ $category[$i]->products[$y]->discounts  }}%
                                                </div>
                                            @endif
                                            ...
                                            @else
                                                <ul class="product__item__pic__hover">
                                                    ...
                                                    <li onclick="addCart({{$category[$i]->products[$y]->id}})"><a><i
                                        ...
                                        <div class="product__discount__item__text">
                                            <h5>
                                                <a href="{{ route('product',['slug'=>$category[$i]->products[$y]->slug]) }}">{{$category[$i]->products[$y]->namePro}}</a>
                                            </h5>
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-6">
                        <div class="blog__item">
                            ...
                            <div class="blog__item__text">
                                <ul>
                                    <li><i class="fa fa-calendar-o"></i> {{ date_format($blog->updated_at,"Y/m/d") }}
                                    </li>
                                    <li><i class="fa fa-comment-o"></i></li>
                                </ul>
                                <h5>
                                    <a href="{{ route('blog',['slug' => $blog->slug_blog ]) }}">{{ $blog->name_blog }}</a>
                                </h5>
