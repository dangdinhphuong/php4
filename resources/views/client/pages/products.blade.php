...
@section('title', 'Suruchi - Thời trang')
@section('content')
            ...
            <div class="row row-cols-1">
                <div class="col">
                    <div class="breadcrumb__content text-center">
                        <h1 class="breadcrumb__content--title text-white mb-25">Suruchi - Thời trang</h1>
                        <ul class="breadcrumb__content--menu d-flex justify-content-center">
                            ...
                            @else
                            <li class="breadcrumb__content--menu__items"><span class="text-white">Tất cả sản phẩm của cửa hàng</span>
                            </li>
                            @endif
                        </ul>
                    </div>
                    ...
                    <div class="product__view--mode__list product__short--by align-items-center d-lg-flex">
                        <div class="select shop__header--select">
                            <select class="product__view--select" onchange="filterSort(this)">
                                <option selected value="">Sắp xếp theo giá</option>
                    ...
                    <div class="product__view--mode__list">
                        <div class="product__grid--column__buttons d-flex justify-content-center">
                            <button class="product__grid--column__buttons--icons active"
                                aria-label="product grid button" data-toggle="tab"
                            ...
                            <button class="product__grid--column__buttons--icons"
                                aria-label="product list button" data-toggle="tab"
                                    ...
                                    <g id="Group_14700" data-name="Group 14700"
                                        ...
                                        <g transform="translate(12 -2)">
                                            ...
                                            <g id="Group_1327" data-name="Group 1327"
                                                ...
                                                <rect id="Rectangle_5731"
                                                    data-name="Rectangle 5731" width="3"
                                                    height="2" transform="translate(1364 487)"
                                                    fill="currentColor" />
                                                <rect id="Rectangle_5732"
                                                    data-name="Rectangle 5732" width="9"
                            ...
                            <form class="price__filter--form" id="filter-form" method="get">
                                <div class="price__filter--form__inner mb-15 d-flex align-items-center">
                                    <div class="price__filter--group">
                                        <label class="price__filter--label"
                                            for="Filter-Price-GTE2">Từ</label>
                                        <div
                                    ...
                                    <div class="price__filter--group">
                                        <label class="price__filter--label"
                                            for="Filter-Price-LTE2">Đến</label>
                                        <div
                                            class="price__filter--input border-radius-5 d-flex align-items-center">
                                            <span class="price__filter--currency">₫</span>
                                            <label>
                                ...
                                <button class="price__filter--btn primary__btn"
                                            ...
                                            <div class="product__items ">
                                                <div class="product__items--thumbnail">
                                                    ...
                                                    <div class="product__badge">
                                                        <span
                                                            class="product__badge--items sale">Giảm giá</span>
                                                    </div>
                                                </div>
                                                <div class="product__items--content">
                                                    <span
                                                        class="product__items--content__subtitle">
                                                    </span>
                                                    <h4
                                                        class="product__items--content__title">
                                                        <a
                                                            href="{{ route('product',['slug'=>$product->slug]) }}">{{ \Illuminate\Support\Str::limit($product->namePro, 50, '...') }}</a>
                                                    </h4>
                                                    ...
                                                    <ul class="product__items--action d-flex">
                                                        <li class="product__items--action__list w-100 text-center"
                                                            ...
                                                            <div class="product__items--action__btn add__to--cart"
                                                                ...
                                                                <span
                                                                    class="add__to--cart__text"> + Thêm vào giỏ hàng</span>
                                                            </div>
                                                        </li>
                                                    </ul>
                                                </div>
        ...
        <div class="container">
            <div class="shipping__section2--inner shipping__style3--inner d-flex justify-content-between">
                ...
                <div class="shipping__items2 d-flex align-items-center">
                    ...
                    <div class="shipping__items2--content">
                        <h2 class="shipping__items2--content__title h3">Trả hàng</h2>
                        <p class="shipping__items2--content__desc">Từ những người bán được chọn lọc</p>
                    </div>
                </div>
                <div class="shipping__items2 d-flex align-items-center">
