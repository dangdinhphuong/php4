                ...
                <div class="col">
                    <div class="breadcrumb__content text-center">
                        ...
                        <ul class="breadcrumb__content--menu d-flex justify-content-center">
                            ...
                            @else
                            <li class="breadcrumb__content--menu__items"><span class="text-white">All
                                    products of the store</span>
                            </li>
                            @endif
                        </ul>
                    </div>
                                ...
                                <div class="price__filter--form__inner mb-15 d-flex align-items-center">
                                    <div class="price__filter--group">
                                        <label class="price__filter--label"
                                            for="Filter-Price-GTE2">From</label>
                                        <div
                                    ...
                                    <div class="price__filter--group">
                                        <label class="price__filter--label"
                                            for="Filter-Price-LTE2">To</label>
                                        <div
                                            class="price__filter--input border-radius-5 d-flex align-items-center">
                                            <span class="price__filter--currency">$</span>
                                            <label>
                            ...
                            <div id="product_list" class="tab_pane">
                                <div class="product__section--inner">
                                    <div class="row row-cols-1 mb--n30">
                                        ...
                                        <div class="col mb-30">
                                            <div
                                                class="product__items product__list--items d-flex">
                                                <div
                                                ...
                                                <div class="product__list--items__content">
                                                    ...
                                                    <h3
                                                        class="product__list--items__content--title h4 mb-10">
                                                        <a
                                                            href="{{ route('product',['slug'=>$product->slug]) }}">{{$product->namePro}}</a>
                                                    </h3>
                                                    <div
                                                        class="product__list--items__price mb-10">
                                                        @if($product->discounts > 0)
                                                        <span
                                                            class="current__price">{{ number_format(($product->price-(($product->price * $product->discounts )/100)), 0, ',', '.') . " VNĐ"   }}</span>
                                                        <span class="price__divided"></span>
                                                    ...
                                                    <ul class="product__items--action d-flex">
                                                        <li
                                                            class="product__items--action__list">
                                                            <div class="product__items--action__btn add__to--cart"
                                                                onclick="addCart({{$product->id}})">
                                                                <svg class="product__items--action__btn--svg"
                                                                    xmlns="http://www.w3.org/2000/svg"
                        ...
                        <div class="pagination__area bg__gray--color">
                            <nav class="pagination justify-content-center">
                                <ul
                                    ...
                                    <!-- Pagination Numbers -->
                                    @foreach ($products->getUrlRange(1, $products->lastPage()) as
                                    $page => $url)
                                    <li class="pagination__list">
