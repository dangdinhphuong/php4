                        ...
                        <div class="blog__details--wrapper">
                            <div class="entry__blog">
                                <div class="blog__post--header mb-30">
                                    <h2 class="post__header--title mb-15">{{$Blog->name_blog }}!</h2>
                                    <p class="blog__post--meta">Posted by : {{ $Blog->User->fullname }} / On : {{ $Blog->updated_at->format('F d, Y') }} </p>
                                </div>
                                <div class="blog__thumbnail mb-30">
{{--                                    <img class="blog__thumbnail--img border-radius-10" src="{{asset('storage/' .$Blog->image)}}" alt="blog-img">--}}
                                </div>
                            ...
                            <div class="blog__tags--social__media d-flex align-items-center justify-content-between">
                                <div class="blog__tags--media d-flex align-items-center">
                                    ...
                                    <ul class="d-flex">
                                        <li class="blog__tags--media__list"><a class="blog__tags--media__link" href="#Popular">Popular</a></li>
                                        <li class="blog__tags--media__list"><a class="blog__tags--media__link" href="#Business">Business</a></li>
                                        <li class="blog__tags--media__list"><a class="blog__tags--media__link" href="#desgin">desgin</a></li>
                                        <li class="blog__tags--media__list"><a class="blog__tags--media__link" href="#Service">Service</a></li>
                                    </ul>
                                </div>
