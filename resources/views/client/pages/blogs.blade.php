            ...
            <div class="row row-cols-1">
                <div class="col">
                    <div class="breadcrumb__content text-center">
                        <h1 class="breadcrumb__content--title text-white mb-25">Bài viết</h1>
                        <ul class="breadcrumb__content--menu d-flex justify-content-center">
                            <li class="breadcrumb__content--menu__items"><a class="text-white"
                                    href="{{ route('home') }}">Trang chủ</a></li>
                            <li class="breadcrumb__content--menu__items"><span class="text-white">Bài viết
                                </span></li>
                        </ul>
                    </div>
                </div>
    ...
    <section class="blog__section section--padding">
        <div class="container">
            <div class="section__heading text-center mb-50">
                <h2 class="section__heading--maintitle">Danh sách bài viết</h2>
            </div>
                        ...
                        <div class="blog__items">
                            <div class="blog__thumbnail">
                                <a class="blog__thumbnail--link"
                                    href="{{ route('blog',['slug' => $blog->slug_blog ]) }}"><img
                            ...
                            <div class="blog__content">
                                <span
                                    class="blog__content--meta">{{ $blog->updated_at->format('F d, Y') }}</span>
                    ...
                    <nav class="pagination justify-content-center">
                        <ul class="pagination__wrapper d-flex align-items-center justify-content-center">
                            ...
                            <li class="pagination__list">
                                <a href="{{ $blogs->previousPageUrl() . '&' . http_build_query(request()->except('page')) }}"
                            ...
                            <li class="pagination__list">
                                <a href="{{ $blogs->nextPageUrl() . '&' . http_build_query(request()->except('page')) }}"
                                    class="pagination__item--arrow link">
                                    <!-- Right Arrow SVG -->
                                    <svg xmlns="http://www.w3.org/2000/svg" width="22.51"
                                        height="20.443" viewBox="0 0 512 512">
