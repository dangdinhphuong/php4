                ...
                <div class="col">
                    <div class="breadcrumb__content text-center">
                        ...
                        <ul class="breadcrumb__content--menu d-flex justify-content-center">
                            ...
                            <li class="breadcrumb__content--menu__items"><span class="text-white">Giỏ
                                    hàng</span></li>
                        </ul>
                    </div>
                </div>
                    ...
                    <div class="col-lg-8">
                        <div class="cart__table">
                            ...
                            <div class="continue__shopping d-flex justify-content-between">
                                <a class="continue__shopping--link" href="{{ route('home') }}">Continue
                                    shopping</a>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="cart__summary border-radius-10">
                            <form action="{{route('checkout')}}" method="post" name="checkout">
                                ...
                                <div class="cart__note mb-20">
                                    <h3 class="cart__note--title">Tên người nhận</h3>
                                    <input class="coupon__code--field__input border-radius-5"
                                        placeholder="Tên người nhận..." type="text" name="fullname"
                                ...
                                <div class="cart__note mb-20">
                                    <h3 class="cart__note--title">Số điện thoại</h3>
                                    <input class="coupon__code--field__input border-radius-5"
                                ...
                                <div class="cart__note mb-20">
                                    <h3 class="cart__note--title">Địa chỉ</h3>
                                    <input class="coupon__code--field__input border-radius-5"
                                ...
                                <div class="cart__note mb-20">
                                    ...
                                    <p class="cart__note--desc">Thêm hướng dẫn đặc biệt cho
                                        người bán của bạn...</p>
                                    ...
                                    <table class="cart__summary--total__table">
                                        <tbody>
                                            <tr class="cart__summary--total__list">
                                                <td
                                                    class="cart__summary--total__title text-left">
                                                    TỔNG CỘNG</td>
                                                <td
                                                    class="cart__summary--amount text-right subtotal">
                                                    {{ number_format(ceil($totalMoney), 0, ',', '.') . " VNĐ" }}
                                                </td>
                                            </tr>
                                            <tr class="cart__summary--total__list">
                                                <td
                                                    ...
                                                    PHÍ VẬN CHUYỂN</td>
                                                <td
                                                    class="cart__summary--amount text-right shipping-fees">
                                                    0 VNĐ
                                                </td>
                                            </tr>
                                            <tr class="cart__summary--total__list">
                                                <td
                                                    ...
                                                    TỔNG CỘNG</td>
                                                <td
                                                    class="cart__summary--amount text-right grand-total">
                                                    {{ number_format(ceil($totalMoney + 0), 0, ',', '.') . " VNĐ" }}
                                                </td>
                                            </tr>
                                        </tbody>
                                    ...
                                    <ul class="d-flex justify-content-between">
                                        ...
                                        <li>
                                            <button
                                                ...
                                                {{ $carts->count() <=0 ? "disabled" : "" }}
                                                id="{{ $carts->count() <=0 ? 'checkout1' : 'checkout' }}">
                                                Thanh toán
                                            </button>
                                        </li>
                                    </ul>
    ...
    $(document).ready(function() {
        ...
        function updateSummary() {
            ...
            $(".cart__table--body__items").each(function() {
                let total = parseFloat($(this).find(".total-price").text().replace(/\./g, '')
                    .replace(" VNĐ", '')) || 0;
                subtotal += total;
            });
