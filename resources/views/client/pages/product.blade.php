                    ...
                    <div class="col">
                        <div class="breadcrumb__content text-center">
                            ...
                            <ul class="breadcrumb__content--menu d-flex justify-content-center">
                                ...
                                <li class="breadcrumb__content--menu__items"><span class="text-white">{{$Product->category->nameCate}}</span></li>
                            </ul>
                        </div>
                    </div>
                </div>
                                ...
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <div class="product__media--preview__items">
                                            <a class="product__media--preview__items--link glightbox" data-gallery="product-media-preview" href="{{asset('storage/' .$Product->image)}}"><img class="product__media--preview__items--img" src="{{asset('storage/' .$Product->image)}}" alt="product-media-img"></a>
                                            <div class="product__media--view__icon">
                                                <a class="product__media--view__icon--link glightbox" href="{{asset('storage/' .$Product->image)}}" data-gallery="product-media-preview">
                            ...
                            <form action="#">
                                ...
                                <div class="product__details--info__price mb-10 p-2" style="background-color: var(--secondary-color);     border-radius: 5px;">
                                    ...
                                    @if($Product->discounts > 0)
                                        <span
                                            class="current__price" style="color: var(--white-color);">{{ number_format(($Product->price-(($Product->price * $Product->discounts )/100)), 0, ',', '.') . " VNĐ"   }}</span>
                                        <span class="price__divided" style="background: var(--white-color);"></span>
                                        <span
                                            class="old__price" style="color: var(--white-color);">{{ number_format($Product->price, 0, ',', '.') . " VNĐ" }}</span>
                                    @else
                                        <span
                                            class="current__price" style="color: var(--white-color);">{{ number_format($Product->price, 0, ',', '.') . " VNĐ" }} </span>
                                    @endif
                                </div>
                                ...
                                <div class="product__variant">
                                    <div class="product__details--info__meta">
                                        <p class="product__details--info__meta--list"><strong>Shock Deal :</strong>  <span>Buy to receive gifts</span> </p>
                                        <p class="product__details--info__meta--list"><strong>Shop with confidence :</strong>  <span>Order Processing by Famous Brands · 15-Day Free Returns ·</span> </p>

                                    </div>
                                    <div class="product__variant--list quantity d-flex align-items-center mb-20">
                                        @csrf
                                        <div class="quantity__box">
                                            <button type="button" onclick="updateQuantity(-1)" class="quantity__value quickview__value--quantity decrease" aria-label="quantity value" value="Decrease Value">-</button>
                                            <label>
                                                <input type="number" class="quantity__number quickview__value--number"  id="quantity" value="1" />
                                            </label>
                                            <button type="button" onclick="updateQuantity(1)" class="quantity__value quickview__value--quantity increase" aria-label="quantity value" value="Increase Value">+</button>
                                        </div>
                                        <button class="quickview__cart--btn primary__btn" onclick="addToCart({{$Product->id}})" {{$Product->quantity <= 0 ? "disabled" : "" }}>{{$Product->quantity <= 0 ? "Product is out of stock" : "Add To Cart" }}</button>
                                    </div>
                                </div>
                                    ...
                                    <div class="product__reviews">
                                        ...
                                        <div class="reviews__comment--area">
                                            ...
                                            <div class="reviews__comment--list margin__left d-flex">
                                                <div class="reviews__comment--thumb">
                                                    <img src="{{asset('assets/img/other/comment-thumb2.png')}}" alt="comment-thumb">
                                                </div>
                                                <div class="reviews__comment--content">
                                                    <div class="reviews__comment--top d-flex justify-content-between">
                                                        <div class="reviews__comment--top__left">
                                            ...
                                            <div class="reviews__comment--list d-flex">
                                                <div class="reviews__comment--thumb">
                                                    <img src="{{asset('assets/img/other/comment-thumb3.png')}}" alt="comment-thumb">
                                                </div>
                                                <div class="reviews__comment--content">
                                                    <div class="reviews__comment--top d-flex justify-content-between">
                                                        <div class="reviews__comment--top__left">
                        ...
                        <div class="swiper-slide">
                            <div class="product__items ">
                                ...
                                <div class="product__items--content">
                                                            <span
                                                                class="product__items--content__subtitle"> {{$category->nameCate ?? ''}}</span>
