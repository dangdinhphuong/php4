            ...
            <div class="main__header--inner position__relative d-flex justify-content-between align-items-center">
                ...
                <div class="main__logo">
                    <h1 class="main__logo--title"><a class="main__logo--link" href="{{ route('home') }}"><img
                                class="main__logo--img" src="{{asset('assets/img/logo/nav-log.png')}}" alt="logo-img"></a></h1>
                </div>
                <div class="header__search--widget header__sticky--none d-none d-lg-block">
                    <form class="d-flex header__search--form" action="{{route('products')}}">
                        ...
                        <div class="header__search--box">
                            <label>
                                <input class="header__search--input" placeholder="Keyword here..." type="text" name="search" value="{{ request('search') }}">
                            </label>
                ...
                <div class="header__account header__sticky--none">
                    <ul class="d-flex">
                        <li class="header__account--items">
                            <a class="header__account--btn " href="{{route('carts')}}"
                               data-offcanvas>
                        ...
                        <li class="header__account--items">
                            <a class="header__account--btn" href="{{route('login')}}">
                                <svg xmlns="http://www.w3.org/2000/svg" width="30" height="23.443" viewBox="0 0 512 512">
                                    <!-- Phần ổ khóa -->
                ...
                <div class="header__menu d-none header__sticky--block d-lg-block">
                    <nav class="header__menu--navigation">
                        <ul class="d-flex">
                            ...
                            <li class="header__menu--items style2">
                                <a class="header__menu--link " href="{{route('blogs')}}">Blog </a>
                            </li>
                            <li class="header__menu--items style2">
                                <a class="header__menu--link " href="{{route('contact')}}">Contact </a>
                            </li>
                            <li class="header__menu--items style2">
                                <a class="header__menu--link " href="{{route('order')}}">Order </a>
                            </li>
                            {{--                            <li class="header__menu--items style2">--}}
        ...
        <div class="container-fluid">
            <div
                ...
                <p class="header__discount--text"><img class="header__discount--icon__img"
                                                       src="{{asset('assets/img/icon/lamp.png')}}" alt="lamp-img"> Special up to 60%
                    Off all item</p>
            </div>
        </div>
    </div>
                    ...
                    <ul class="d-flex align-items-center">
                        <li class="language__currency--list">
                            <a class="offcanvas__language--switcher" href="#">
                                <img class="language__switcher--icon__img" src="{{asset('/img/icon/language-icon.png')}}"
                                     alt="currency">
                                <span>English</span>
