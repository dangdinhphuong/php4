<header class="header__section">
                    ...
                    <form class="d-flex header__search--form" action="{{route('products')}}">
                        <div class="header__select--categories select">
                            <select class="header__select--inner"
                                ...
                                <option
                                    value="{{ route('products') . '?slug_cate=' . $category->slug }}"
                                    {{ !empty(request('slug_cate')) && request('slug_cate') == $category->slug ? 'selected' :  ''  }}>
                                    {{ $category->nameCate }}
                                </option>
                                @endforeach
                            </select>
                ...
                <div class="header__account header__sticky--none">
                    <ul class="d-flex">
                        <li class="header__account--items">
                            <a class="header__account--btn " href="{{route('carts')}}" data-offcanvas>
                        ...
                        <li class="header__account--items">
                            <a class="header__account--btn" href="{{route('profile')}}">
                                <svg xmlns="http://www.w3.org/2000/svg" width="26.51" height="23.443"
                                    viewBox="0 0 512 512">
                        ...
                        <li class="header__account--items">
                            <a class="header__account--btn" href="{{route('login')}}">
                                <svg xmlns="http://www.w3.org/2000/svg" width="30" height="23.443"
                                    viewBox="0 0 512 512">
                                    <!-- Phần ổ khóa -->
                                    <rect x="144" y="224" width="224" height="224" rx="24" ry="24"
                                        fill="none" stroke="currentColor" stroke-linejoin="round"
                                        stroke-width="32" />
                                    <!-- Phần vòng khóa -->
                                    <path d="M368 224v-80c0-61.86-50.14-112-112-112s-112 50.14-112 112v80"
                                        fill="none" stroke="currentColor" stroke-linecap="round"
                                        stroke-linejoin="round" stroke-width="32" />
                                </svg>
                ...
                <div class="header__menu d-none header__sticky--block d-lg-block">
                    <nav class="header__menu--navigation">
                        <ul class="d-flex">
                            ...
                            <li class="header__menu--items style2">
                                <a class="header__menu--link " href="{{route('blogs')}}">Bài viết </a>
                            </li>
                            <li class="header__menu--items style2">
                                <a class="header__menu--link " href="{{route('contact')}}">Liên hệ </a>
                            </li>
                            <li class="header__menu--items style2">
                                <a class="header__menu--link " href="{{route('order')}}"> Hóa đơn</a>
                            </li>
                            {{-- <li class="header__menu--items style2">--}}
                    ...
                    <ul class="d-flex">
                        <li
                            ...
                            <a class="header__account--btn search__open--btn" href="javascript:void(0)"
                                data-offcanvas>
                                <svg class="header__search--button__svg"
                                    xmlns="http://www.w3.org/2000/svg" width="26.51" height="23.443"
                                    viewBox="0 0 512 512">
                                    <path d="M221.09 64a157.09 157.09 0 10157.09 157.09A157.1 157.1 0 00221.09 64z"
                                        fill="none" stroke="currentColor" stroke-miterlimit="10"
                                        stroke-width="32" />
        ...
        <div class="container-fluid">
            <div
                ...
                <p class="header__discount--text"><img class="header__discount--icon__img"
                        src="{{asset('assets/img/icon/lamp.png')}}" alt="lamp-img"> Đặc biệt lên đến 60%
                    tất cả mặt hàng </p>
            </div>
        </div>
    </div>
        ...
        <div class="offcanvas__inner">
            ...
            <nav class="offcanvas__menu">
                <ul class="offcanvas__menu_ul">
                    ...
                    <li class="offcanvas__menu_li">
                        <a class="offcanvas__menu_item" href="{{route('order')}}">Order </a>
                    </li>
                </ul>
    ...
    <div class="offcanvas__stikcy--toolbar">
        <ul class="d-flex justify-content-between">
            ...
            <li class="offcanvas__stikcy--toolbar__list">
                <a class="offcanvas__stikcy--toolbar__btn " href="{{route('carts')}}" data-offcanvas>
                    <span class="offcanvas__stikcy--toolbar__icon">
    ...
    <div class="offCanvas__minicart">
        ...
        <div class="minicart__product">
            ...
            <div class="minicart__product--items d-flex">
                <div class="minicart__thumb">
                    <a href="product-details.html"><img src="{{asset('/img/product/product2.png')}}"
                            alt="prduct-img"></a>
                </div>
                <div class="minicart__text">
                    <h3 class="minicart__subtitle h4"><a href="product-details.html">Boxy Denim Jacket</a>
                    </h3>
        ...
        <div class="minicart__conditions text-center">
            ...
            <label class="minicart__conditions--label" for="accept">I agree with the <a
                    class="minicart__conditions--link" href="privacy-policy.html">Privacy and
                    Policy</a></label>
        </div>
    ...
    <div class="predictive__search--box ">
        <div class="predictive__search--box__inner">
            ...
            <form class="predictive__search--form" action="{{route('products')}}">
                <label>
                    <input class="predictive__search--input" placeholder="Search Here" name="search"
                        type="text">
                </label>
