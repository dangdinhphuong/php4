        ...
        <section class="product__section section--padding pt-0">
            <div class="container-fluid">
                ...
                <ul class="product__tab--one product__tab--primary__btn d-flex justify-content-center mb-50">
                    ...
                    @if( isset($category) && $category->count()>0)
                        @for( $i=0 ; $i < $category->count() ; $i++)
                            @if($i < 3)
                                <li class="product__tab--primary__btn__list {{ $i == 0 ? 'active' : ''  }}" data-toggle="tab"
                                    data-target="#{{$category[$i]->slug}}">
                                    {{$category[$i]->nameCate}}
                                </li>
                            @endif
                        @endfor
                ...
                <div class="tab_content">
                    @for( $i=0 ; $i < $category->count() ; $i++)
                        @if($i < 3)
                            <div id="{{$category[$i]->slug}}" class="tab_pane {{ $i == 0 ? 'active show' : ''  }}">
                                                    ...
                                                    <div class="product__items ">
                                                        ...
                                                        <div class="product__items--content">
                                                            ...
                                                            <ul class="product__items--action d-flex">
                                                                <li class="product__items--action__list w-100 text-center" style="">
                                                                    <div
                    ...
                    <div class="row row-cols-1 align-items-center">
                        <div class="col">
                            <div class="deals__banner--content position__relative">
                                ...
                                <p class="deals__banner--content__desc">Lorem ipsum dolor sit amet, consectetur
                        ...
                        <div class="banner__items position__relative">
                            <a class="banner__items--thumbnail " href="shop.html"><img
                                ...
                                <div class="banner__items--content">
                                    <span
                                        class="banner__items--content__subtitle d-none d-lg-block">Pick Your Items</span>
                    ...
                    <div class="col mb-28">
                        <div class="banner__items position__relative">
                            <a class="banner__items--thumbnail " href="shop.html"><img
                                ...
                                <div class="banner__items--content">
                                    <span
                                        class="banner__items--content__subtitle d-none d-lg-block">Special offer</span>
                        ...
                        <div class="swiper-slide">
                            <div class="blog__items">
                                ...
                                <div class="blog__content">
                                    <span class="blog__content--meta">{{ date_format($blog->updated_at,"Y/m/d") }}</span>
